...
use crate::parsers::{
    ...
    ARG_HDB, ARG_HDC, ARG_HDD, ARG_INITRD, ARG_JITDUMP, ARG_K, ARG_KERNEL, ARG_L, ARG_LITTLE_S, ARG_LOADVM, ARG_MEM_PATH, ARG_MEM_PREALLOC, ARG_MTDBLOCK, ARG_NO_FD_BOOTCHK, ARG_NO_REBOOT,
    ARG_NO_SHUTDOWN, ARG_NO_USER_CONFIG, ARG_NODEFAULTS, ARG_NOGRAPHIC, ARG_ONLY_MIGRATABLE, ARG_OPTION_ROM, ARG_PERFMAP, ARG_PFLASH, ARG_PIDFILE, ARG_PRECONFIG, ARG_READCONFIG, ARG_SD, ARG_SEED,
    ARG_SHIM, ARG_SNAPSHOT, ARG_USB, ARG_WIN2K_HACK, ARG_XEN_ATTACH, ARG_XEN_DOMID_RESTRICT, ARG_XEN_ID,
};
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        while let Some(token) = tokens.next() {
            match token.as_str() {
                ...
                ARG_BIG_D => ffs!(tokens, ARG_BIG_D, String, q.d),
                ...
                other => {
                    eprintln!("arg key '{:?}' is not supported", other);
                    todo!()
                }
            }
        }
