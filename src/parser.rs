    ...
    <Machine as FromStr>::Err: std::fmt::Display,
{
    ...
    while let Some(token) = tokens.next() {
        match token.as_str() {
            ...
            ARG_ADD_FD => ffs!(tokens, ARG_ADD_FD, AddFd, q.add_fd),
            ...
            ARG_AUDIODEV => ffs!(tokens, ARG_AUDIODEV, AudioDev, q.audiodev),
            ...
            ARG_FSDEV => ffs!(tokens, ARG_FSDEV, FsDev, q.fsdev),
            ARG_VIRTFS => ffs!(tokens, ARG_VIRTFS, Virtfs, q.virtfs),
            ...
            ARG_ACPITABLE => ffs!(tokens, ARG_ACPITABLE, AcpiTable, q.acpitable),
            ...
            ARG_TPMDEV => ffs!(tokens, ARG_TPMDEV, TpmDev, q.tpmdev),
            ...
            ARG_FW_CFG => ffs!(tokens, ARG_FW_CFG, FwCfg, q.fw_cfg),
            ARG_SERIAL => ffs!(tokens, ARG_SERIAL, SpecialDevice, q.serial),
            ARG_PARALLEL => ffs!(tokens, ARG_PARALLEL, SpecialDevice, q.parallel),
            ARG_MONITOR => ffs!(tokens, ARG_MONITOR, SpecialDevice, q.monitor),
            ARG_QMP => ffs!(tokens, ARG_QMP, SpecialDevice, q.qmp),
            ARG_QMP_PRETTY => ffs!(tokens, ARG_QMP_PRETTY, SpecialDevice, q.qmp_pretty),
            ...
            ARG_PLUGIN => ffs!(tokens, ARG_PLUGIN, Plugin, q.plugin),
