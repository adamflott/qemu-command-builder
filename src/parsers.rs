...
pub(crate) const ARG_MACHINE_ALIAS: &str = "-M";
...
pub(crate) const ARG_NET: &str = "-net";
pub(crate) const ARG_NIC: &str = "-nic";
...
pub(crate) const ARG_NO_HPET: &str = "-no-hpet";
...
pub(crate) const ARG_ONLY_CPR_CAPABLE: &str = "-only-cpr-capable";
pub(crate) const ARG_MIGRATE_MODE_ENABLE: &str = "-migrate-mode-enable";
...
pub(crate) const ARG_PROM_ENV: &str = "-prom-env";
pub(crate) const ARG_PRECONFIG: &str = "--preconfig";
pub(crate) const ARG_QMP: &str = "-qmp";
pub(crate) const ARG_QMP_PRETTY: &str = "-qmp-pretty";
pub(crate) const ARG_QTEST: &str = "-qtest";
pub(crate) const ARG_QTEST_LOG: &str = "-qtest-log";
...
pub(crate) const ARG_SEMIHOSTING: &str = "-semihosting";
pub(crate) const ARG_SEMIHOSTING_CONFIG: &str = "-semihosting-config";
